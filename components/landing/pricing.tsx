        ...
        <div className="w-full px-4">
          <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
            ...
            <p className="text-base text-body-color">
              Based on your school size, choose the plan that fits your needs.
            </p>
          </div>
        </div>
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="relative z-10 px-8 py-10 mb-10 overflow-hidden bg-white border rounded-xl border-opacity-20 shadow sm:p-12 lg:py-10 lg:px-6 xl:p-12">
            ...
            <span className="absolute right-0 top-7 z-[-1]">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stopColor="#18181B" stopOpacity="0.09" />
